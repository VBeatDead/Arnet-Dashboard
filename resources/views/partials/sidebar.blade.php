    ...
    <div class="offcanvas-lg offcanvas-start text-bg-dark pb-5" id="sidebar">
        ...
        <div class="p-3 text-center">
            <a href="{{ url('img/LOGO BULAT.png') }}" class="block">
                <img src="{{ asset('img/LOGO_PANJANG.png') }}" alt="LOGO TRANSPARAN" class="img-fluid mx-auto mb-2 rectangular-logo" width="150" height="50">
                <img src="{{ asset('img/LOGO BULAT.png') }}" alt="LOGO BULAT TRANSPARAN" class="mx-auto dark-mode-logo" width="50">
            </a>
        </div>
                    ...
                    <div id="submenu-admin" class="accordion-collapse collapse show">
                        <div class="accordion-body p-0 px-3">
                            <div class="list-group list-group-flush">
                                ...
                                <a href="{{ url('/topology') }}" class="list-group-item list-group-item-action border-0 mb-1 text-bg-dark {{ Request::is('topology') ? 'active' : '' }}" data-bs-placement="right" data-bs-title="Topology">
                                ...
                                <a href="{{ url('/device') }}" class="list-group-item list-group-item-action border-0 mb-1 text-bg-dark {{ Request::is('device') ? 'active' : '' }}" data-bs-placement="right" data-bs-title="Surat">
